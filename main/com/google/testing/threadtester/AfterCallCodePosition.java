 ...
 */
class AfterCallCodePosition extends CallCodePosition {

  /**
   * Creates a position based on a reference to the method called.
   *
   ...
   */
  AfterCallCodePosition(Method method, Method calledMethod) {
    super(method, calledMethod);
  }

  /**
   * Creates a position based on the name of the method called.
   *
   * @param method the method making a call
   * @param calledMethodName the name of the method being called
   * @see ClassInstrumentation#beforeCall(String, String)
   */
  AfterCallCodePosition(Method method, String calledMethodName) {
    super(method, calledMethodName);
  }

  @Override
  public String toString() {
   return "in " + method.getName() + ", after calling " + getCalledMethodName();
  }
}
